...
d2l.set_figsize()
img = d2l.Image.open('D:/Code/DeepLearning/Week5_CV/img/cat1.png')
d2l.plt.imshow(img)
...
#RandomResizedCrop size:resize的尺寸，scale：选取区域比例的上下限,ratio：高宽比的上下限
shape_aug = torchvision.transforms.RandomResizedCrop(size=(200,200),scale=(0.1,1),ratio=(0.5,2))
#apply(img,shape_aug)

#参数的意思就是上下抖动50%，均匀地取  0 or 1-0.5  ~ 1+0.5
